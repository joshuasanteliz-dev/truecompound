...
const COPY = {
  ...
  es: {
    ...
    intro:
      `Te enseñan el número limpio y dejan fuera las fuerzas que lo cambian. ${previewBrandName} revela inflación, timing, deuda, impuestos e incertidumbre para que el interés compuesto se sienta más real.`,
    primaryCta: 'Empieza con la inflación',
    secondaryCta: 'Explora las capas ocultas',
    supportLabel: 'Lo que se revela',
    supportIntro: `Las calculadoras normales muestran un número limpio. ${previewBrandName} muestra las capas debajo.`,
    supportItems: ['Erosión por inflación', 'Arrastre fiscal', 'Riesgo de timing', 'Deuda compuesta', 'Rango probable'],
    heroLabel: 'Escenario de ejemplo',
    heroAssumption: '$10,000 hoy + $500/mes durante 30 años al 8% nominal',
    ...
    revealedValue: '$429,000',
    revealedAmount: 429000,
    ledgerTitle: 'Qué cambió el número',
    chartTitle: 'Crecimiento nominal comparado con poder de compra revelado',
    chartDesc:
      'La línea superior muestra el número nominal. La línea inferior muestra el valor revelado después de considerar capas ocultas.',
    layersHeading: 'Cinco capas ocultas. Cinco calculadoras enfocadas.',
    layersIntro:
      'Elige la fuerza que quieres inspeccionar primero. Cada herramienta mantiene la matemática enfocada, visible y práctica.',
    trustHeading: 'Matemática útil, no un embudo de ventas.',
    trustBody:
    ...
    aboutLink: 'Más sobre el proyecto',
    openTool: 'Abrir calculadora',
    rows: [
      { name: 'Inflación', detail: 'Los precios también componen', value: '-$414k', tone: 'amber' },
    ...
    modes: [
      {
        to: '/inflation',
        layer: 'Inflación',
        title: 'El número crece. El poder de compra cambia.',
        reason: 'Compara el crecimiento nominal con lo que el dinero podría comprar en dólares de hoy.',
      ...
      },
      {
        ...
        reason: 'Mira cómo lump sum y DCA se comportan en ventanas de mercado con forma real.',
      ...
      },
      {
        ...
        reason: 'Refleja crecimiento de inversión contra arrastre de deuda para ver la misma matemática en ambos sentidos.',
      ...
      },
      {
        ...
        reason: 'Cambia una previsión suave por un rango de futuros posibles y resultados de supervivencia.',
